  ...
  return (
    <div className="min-h-screen animated-bg relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-10 right-10 w-80 h-80 bg-gradient-to-r from-purple-400/20 to-pink-500/20 rounded-full blur-3xl floating-animation" style={{ animationDelay: '-4s' }}></div>
        <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-gradient-to-r from-emerald-400/20 to-teal-500/20 rounded-full blur-3xl floating-animation" style={{ animationDelay: '-8s' }}></div>
        <div className="absolute bottom-1/3 left-1/4 w-72 h-72 bg-gradient-to-r from-yellow-400/15 to-orange-500/15 rounded-full blur-3xl floating-animation" style={{ animationDelay: '-12s' }}></div>
      </div>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              className="btn-glass-primary hover:scale-105 transition-all duration-300 group"
            >
      ...
      <section className="container mx-auto px-4 py-20 text-center relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <span className="text-yellow-400 font-semibold">100% Free Forever</span>
          </div>
          ...
          <Card className="glass-card max-w-md mx-auto mb-16 hover-lift glow-effect">
            ...
            <CardContent>
              <Button
                onClick={() => setShowAuth(true)}
                className="w-full h-14 btn-glass-primary font-semibold text-lg hover:scale-105 transition-all duration-300 group bg-gradient-to-r from-cyan-600 to-purple-600 hover:from-cyan-500 hover:to-purple-500"
              >
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <span className="text-slate-200 font-bold text-lg bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">SAWD LINK</span>
            </div>
