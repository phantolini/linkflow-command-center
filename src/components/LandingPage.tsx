      ...
      <section className="container mx-auto px-4 py-20 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="w-24 h-24 floating-animation lg:mx-0 mx-auto">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-xl text-slate-200/90 mb-8 leading-relaxed font-medium max-w-2xl lg:mx-0 mx-auto">
          ...
          <div className="flex justify-center lg:justify-end">
            <Card className="glass-card max-w-md w-full hover-lift glow-effect">
              <CardHeader>
